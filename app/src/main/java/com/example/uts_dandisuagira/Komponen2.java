...
public class Komponen2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button_syntax.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent a = new Intent(Komponen2.this,Syntax2.class);
                startActivity(a);
            }
        });
    ...
    public void link(View view) {
        Intent b = new Intent(Intent.ACTION_VIEW, Uri.parse("https://developer.android.com/guide/topics/manifest/service-element"));
        startActivity(b);
    }
}
